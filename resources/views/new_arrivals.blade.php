          ...
          <div class="col-md-9 order-1">
            ...
            <div class="row mb-5">
                    ...
                    <div class="col-lg-6 col-md-6 item-entry mb-4">
                        <a href="/shop-single/{{$product->id}}" class="product-item md-height bg-gray d-block">
                        <img src='{{asset('storage/'.$product->photo)}}' alt='' srcset=''>
                          </a>
                        <h2 class="item-title"><a href="/shop-single/{{$product->id}}" >{{$product->name}}</a></h2>
